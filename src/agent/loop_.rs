...
// Tool filtering logic has been extracted to `tool_filter.rs`.
use super::tool_filter::compute_excluded_mcp_tools;
#[cfg(test)]
use super::tool_filter::{filter_by_allowed_tools, filter_tool_specs_for_turn};
...
// Tool-call parsing, history formatting, and related helpers have been
// extracted to `tool_call_parser.rs` to reduce file size.
...
mod tests {
    ...
    use crate::agent::tool_filter::glob_match;
